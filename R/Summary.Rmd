...
conexp <- read_csv(here("data", "foodstatisticspocketbook-consumerexpenditure-19oct17.csv"))
...
ggplot(data = conexp, aes(x = year, y = expenditure)) +
  ...
  # geom_text_repel(data = subset(conexp, year == 2013), aes(label = factor(type), colour = factor(type))) +
