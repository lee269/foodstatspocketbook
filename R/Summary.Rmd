...
# Thoughts
# params (not used so far) could be filenames of csvs to use for charts
# And should we read in csvs for toggle charts and kable them?
...
knitr::include_graphics(here::here("img", "agrifoodchain-infographic.png"))

# so we force copy the graphic during rendering to ensure it is in the output
# folder
file.copy(from = here::here("img", "agrifoodchain-infographic.png"),
          to = here::here("output", "figures", "1-agrifoodchain-infographic.png"),
          overwrite = TRUE)
...
# read file 
tfp <- read_csv(here::here("data", "foodstatisticspocketbook-foodchainproductivity-19oct17.csv"))
...
```{r 3-summary-consexp, echo=FALSE, fig.path="../output/figures/", include=FALSE}

conexp <- read_csv(here::here("data", "foodstatisticspocketbook-consumerexpenditure-19oct17.csv"))
...
```{r 4-summary-prices, echo=FALSE, fig.path="../output/figures/", include=FALSE}

cpi <- read_csv(here::here("data", "foodstatisticspocketbook-foodpriceinflation-19oct17.csv"))
...
```{r 5-summary-mintel, echo=FALSE, results='asis', warning=FALSE, message=FALSE}
